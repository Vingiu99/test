...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './paziente.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAZIENTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAZIENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAZIENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAZIENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAZIENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAZIENTE actions', async () => {
      const expectedActions = [
        {
