...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRENOTAZIONE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRENOTAZIONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRENOTAZIONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRENOTAZIONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRENOTAZIONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRENOTAZIONE actions', async () => {
      const expectedActions = [
        {
