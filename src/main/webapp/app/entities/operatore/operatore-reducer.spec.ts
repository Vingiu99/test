...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './operatore.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPERATORE_LIST actions', async () => {
    ...
    it('dispatches FETCH_OPERATORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OPERATORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OPERATORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OPERATORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OPERATORE actions', async () => {
      const expectedActions = [
        {
